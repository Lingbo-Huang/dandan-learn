...
> **来源**：[AI Quant Book · L01](https://github.com/waylandzhang/ai-quant-book)
...
> **注**：本课展示的是完整的多智能体目标架构。实际开发中，推荐从**模块化单体**（Modular Monolith）起步——所有 Agent 在同一进程内运行，通过清晰的接口边界通信。随着规模增长再逐步拆分为独立服务。详见第 21 课。
