...
> **来源**：[AI Quant Book · L05](https://github.com/waylandzhang/ai-quant-book)
...
当太多人使用同一策略时，策略会失效——这就是**策略同质化**（Strategy Crowding）风险。2024 年初，中国头部量化基金因小盘股因子拥挤集体亏损 8-13%，揭示了策略趋同的系统性风险。任何策略在被广泛采用后，超额收益都会衰减。详见第 18 课的策略拥挤案例分析。
